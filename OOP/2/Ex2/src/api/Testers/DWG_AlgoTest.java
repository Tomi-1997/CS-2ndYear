...
//        // TSP
//        ArrayList<NodeData> tsplist = new ArrayList<>();
//
//        for (int i = 0; i < 10; i++) {
//            double rnd = Math.random()*V;
//            tsplist.add(new Vertex(new Point3D(0,0,0),(int)(rnd)));
//        }
//        ga.tsp(tsplist);

        // SHORTEST PATH
        int a = (int)(Math.random()*(V/2));
        int b = (int)(Math.random()*(V/2)) + V/2;
