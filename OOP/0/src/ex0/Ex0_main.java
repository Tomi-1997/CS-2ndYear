    ...
    public static void main(String[] ar) {
      ...
      //   ElevatorAlgo ex0_alg = new ShabatElevAlgo(Simulator_A.getBuilding());  // The simplest algo ever (Shabat Elev).
       //  ElevatorAlgo ex0_alg = new ShabatElev2Algo(Simulator_A.getBuilding()); // Shabat Elev with a minor twist
        //ElevatorAlgo myAlgo = new ShabatElev3Algo(Simulator_A.getBuilding());    // Shabat Elev with two trick - replace with your code;
        ElevatorAlgo myAlg = new myAlgo(Simulator_A.getBuilding());
        Simulator_A.initAlgo(myAlg); // init the algorithm to be used by the simulator
